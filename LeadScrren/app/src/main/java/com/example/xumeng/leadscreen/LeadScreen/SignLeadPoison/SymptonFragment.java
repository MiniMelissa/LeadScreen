 ...
 */
public class SymptonFragment extends Fragment {

    private String filename="Signs";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
//        return inflater.inflate(R.layout.fragment_sympton, container, false);

        LinearLayout l = (LinearLayout) inflater.inflate(R.layout.fragment_sympton, container, false);
