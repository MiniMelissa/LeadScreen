 ...
 */
public class CLevelNineFragment extends Fragment {

    private String filename="Cnine";
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
//        return inflater.inflate(R.layout.fragment_clevel_nine, container, false);
        LinearLayout l=(LinearLayout) inflater.inflate(R.layout.fragment_clevel_nine, container, false);
