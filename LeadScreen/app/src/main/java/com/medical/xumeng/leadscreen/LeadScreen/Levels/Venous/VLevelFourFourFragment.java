 ...
 */
public class VLevelFourFourFragment extends Fragment {

    private String filename1="Vfourfour",filename2="Vfourfour2";
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        LinearLayout l=(LinearLayout) inflater.inflate(R.layout.fragment_vlevel_four_four, container, false);
