 ...
 */
public class CLevelSeventyFragment extends Fragment {

    private String filename="Cseventy";
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
//        return inflater.inflate(R.layout.fragment_clevel_seventy, container, false);
        LinearLayout l=(LinearLayout) inflater.inflate(R.layout.fragment_clevel_seventy, container, false);
