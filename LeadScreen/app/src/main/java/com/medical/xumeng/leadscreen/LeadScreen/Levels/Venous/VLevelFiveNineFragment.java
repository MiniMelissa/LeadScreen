 ...
 */
public class VLevelFiveNineFragment extends Fragment {

    private String filename1="Vfivenine",filename2="Vfivenine2",filename3="Vfivenine3";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        LinearLayout l=(LinearLayout) inflater.inflate(R.layout.fragment_vlevel_five_nine, container, false);
