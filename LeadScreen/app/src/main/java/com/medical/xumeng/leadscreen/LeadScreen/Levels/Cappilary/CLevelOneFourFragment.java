 ...
 */
public class CLevelOneFourFragment extends Fragment {

    private String filename="Conefour";
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
//        return inflater.inflate(R.layout.fragment_clevel_one_four, container, false);
        LinearLayout l=(LinearLayout) inflater.inflate(R.layout.fragment_clevel_one_four, container, false);
